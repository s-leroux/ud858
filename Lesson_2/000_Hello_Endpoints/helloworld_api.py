...
HELLO_REQUEST_CONTAINER = endpoints.ResourceContainer(
    message_types.VoidMessage,
    name=messages.StringField(1),
)

GREET_BY_PERIOD_REQUEST_CONTAINER = endpoints.ResourceContainer(
    message_types.VoidMessage,
    name=messages.StringField(1),
...
class HelloWorldApi(remote.Service):
    ...
    def say_hello(self, request):
      return Hello(greeting="HHello World")

    @endpoints.method(HELLO_REQUEST_CONTAINER, Hello,
    ...
    @endpoints.method(GREET_BY_PERIOD_REQUEST_CONTAINER, Hello,
